...
export const books: Book[] = [
  {
    ...
    buyLinks: {
      ebookChannels: [
        ...
        {
          name: "Booktopia",
          url: "https://www.booktopia.com.au/doctor-defender-v-s-rsv-adil-mukhi/ebook/1230009348349.html?srsltid=AfmBOoqBb7BurotjcJvDaHAf8P0YOU03A1h3Qc2GgWawBBLezsBILfW1",
        },
      ],
      customLinks: [
        {
