...
export const workExperiences: WorkExperience[] = [
  ...
  },
  {
    ...
    longDescription: "Supported the CIHR grant application submission for the OPTIMAL Project (SickKids) studying youth social media use. Collaborated with 20+ members nationwide on health equity projects, policy recommendations, and consultations, contributing to evidence-based youth advocacy and research initiatives.",
    stats: ["20+ members collaborated with", "1 national research project", "Policy recommendations submitted"],
    image: "/ycrh.jpg",
