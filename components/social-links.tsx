...
import { Instagram, Linkedin, Github, Twitter, Link } from "lucide-react"
...
const socialLinks = [
  ...
  { name: "Twitter", icon: Twitter, url: "https://twitter.com/yourusername", color: "text-sky-400" },
...
export default function SocialLinks() {
  return (
    <section id="social-links" className="container py-16">
      <h2 className="mb-12 text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Connect With Me</h2>
