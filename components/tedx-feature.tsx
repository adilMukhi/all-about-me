...
export default function TedxFeature() {
  return (
    <section className="py-16 bg-gradient-to-b from-background to-red-50">
      <div className="container max-w-4xl">
        <h2
          className="text-3xl font-bold tracking-tighter text-center mb-8 sm:text-4xl text-primary"
          style={{ fontFamily: "Sour Gummy, latin" }}
        >
          TEDx Talk
        </h2>
        <Card className="overflow-hidden border-red-200 bg-gradient-to-br from-white to-red-50/50">
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">
              ...
              neuroplasticity and stress hormones, I break down the science behind memory formation and how chronic
              stress impacts our cognitive abilities.
            </p>
