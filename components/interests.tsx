...
const interests = {
  sports: ["Basketball", "Tennis", "Hiking"],
  hobbies: ["Photography", "Chess", "Cooking"],
  teams: ["Local Basketball League", "Photography Club"],
}

export default function Interests() {
  return (
    <section id="interests" className="container py-16">
      <h2 className="mb-12 text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Interests</h2>
