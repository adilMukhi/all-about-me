  ...
  return (
    <section className="bg-primary/10 py-16">
      <div className="container flex flex-col items-center justify-center gap-4 text-center">
        <h1 className="text-4xl font-bold tracking-tighter text-primary sm:text-5xl md:text-6xl lg:text-7xl normal-case" style={{ fontFamily: "Bangers, latin", letterSpacing: '0.1em'}}>
          Hi, I'm Adil Mukhi!
        </h1>
