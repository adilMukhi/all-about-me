...
export default function Skills() {
  return (
    <section id="skills" className="container py-16" style={{ fontFamily: "'Times New Roman', Times, serif" }}>
      <h2 className="mb-12 text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl" style={{ fontFamily: "Bangers, 'Times New Roman', serif" }}>Skills</h2>
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="bg-gradient-to-br from-card to-background shadow-md">
          ...
          <CardContent style={{ fontFamily: "'Kirang Haerang', 'Times New Roman', serif" }}>
